...
(1) preparation step. In this step, we construct 10 polymer models for each chromosome from DNA accessibility data and generate initial structures of 100,000 bead polymer chain as starting points for randomly folded conformation generation.
...
(1)In the folder ./prepare/ATAC_data/bin_10kb/further/, there are 23 files(density1.dat, density2.dat, ...) containing ATAC-seq signals assigned to each 10-kb segments. density1.dat for chromosome 1, density2.dat for chromosome 2, and etc. density23.dat for chromosome X.
(2)In the folder ./prepare/assign/1/detail, there are 10 files(len_10kb_rep1.dat, len_10kb_rep2.dat, ...) containing the information for 10 heteropolymer models of chromosome 1. In each file, value of the i-th row represent the k value for i-th 10-segment. Similar files for other chromosomes are presented in the directory ./prepare/assign/. For example, ./prepare/assign/2/detail for chromosome 2 and ./prepare/assign/23/detail for chromosome X
